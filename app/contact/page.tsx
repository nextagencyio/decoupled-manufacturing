...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Ironforge Manufacturing. We\'d love to hear from you about manufacturing services, custom orders, or facility tours.',
  keywords: ['Contact Ironforge Manufacturing', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about manufacturing services, custom orders, or facility tours? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@ironforgemfg.com</p>
                    <p className="text-gray-600">support@ironforgemfg.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 901-2324</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      5000 Industrial Boulevard<br />
                      Manufacturing Park<br />
                      Detroit, MI 48201
                    </p>
                  </div>
                </div>
